'''
Some TODO-s
    # redo plotting procedure for heatmap (search zone),
        1. take known points & use kriging to fill in unknown areas
        2. plot w. 1 call to scatterplot
           or even better: create a new ax, plot a surface plot onto it and insert onto figure
